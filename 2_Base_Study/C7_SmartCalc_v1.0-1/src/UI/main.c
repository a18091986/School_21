...
int main(int argc, char * argv[]) {
    ...
    if(!gtk_builder_add_from_file(ui_builder, "calc_ui.glade", &err)) {
    ...
    label_result = GTK_WIDGET(gtk_builder_get_object(ui_builder, "label_result"));
    input_expression = GTK_ENTRY(gtk_builder_get_object(ui_builder, "input_expression"));
    input_x = GTK_ENTRY(gtk_builder_get_object(ui_builder, "input_x"));
