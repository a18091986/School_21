...
void * s21_memchr(const void *str, int c, size_t n);  // поиск первого вхождения символа с (беззнаковый) в первых n байтах строки
...
void * s21_memmove(void *dest, const void *src, size_t n); // Копирует n символов из src в dest
